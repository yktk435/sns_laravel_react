...
const Login = (props) => {
    const {inputUserName,inputPass,pushLoginButton }=props
    return (
        <div style={{ padding: "10px" }}>
            <div aria-label="外側" style={{ margin: "0 auto", width: "600px" }}>
                ...
                <div style={{ marginBottom: "20px" }}>
                    <Link to="home" style={{textDecoration:"none"}}><a onClick={pushLoginButton} className="a-to-block2 btn--orange" href="" style={{ borderRadius: "30px", height: "50px", textAlign: "center", width: "550px", margin: "0 auto" }}><p style={{ padding: "10px" }}>ログイン</p></a></Link>
                </div>
                {/* <!-- パスワードを忘れた・アカウント作成 --> */}
                <div>
